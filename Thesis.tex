...
\examiner    {Prof. Anja Feldmann, Ph.D.}
\secondexaminer {Dr. Tobias Fiebig}
\degree      {Master of Science}
\thesiskind  {Master Thesis}
\authors     {Jaideep More}
\thesistitle {Practical SVC video streaming over partially realiable transport}
\date        {\today}
%\subject     {}
%\keywords    {}
%% ----------------------------------------------------------------
...
\todo{We want to put an abbreviations section}
\clearpage

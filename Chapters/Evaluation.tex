\section{Experimental Setup}
    ...
    \subsection{Test Videos and Encodings}
        ...
        \todo{we should add a bitrate column in the table}
        \begin{table}[H]
            \centering
            \begin{tabular}{clccr}
    ...
    \subsection{Evaluation Methodology}
        ...
        \begin{figure}[H]
            \centering
            \todo{do we need a diagram to show this methodology?}
            \caption{Evaluation pipeline overview}
            \label{fig:evaluation_pipeline}
        \end{figure}

        For each video, we create separate scalable video bitstreams, each
